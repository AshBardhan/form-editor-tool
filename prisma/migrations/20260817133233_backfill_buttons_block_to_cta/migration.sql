...
-- Form.submitLabel/resetLabel/ctaAlignment/ctaReverse columns, then remove the
...
SET
  ...
  "ctaAlignment" = COALESCE(NULLIF(b.props->>'alignment', ''), f."ctaAlignment"),
  "ctaReverse" = COALESCE((b.props->>'reverse')::boolean, f."ctaReverse")
