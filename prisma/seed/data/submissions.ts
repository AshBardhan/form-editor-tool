...
export const seedSubmissions = [
  ...
  // ========================================
  {
    ...
    responses: [
      ...
      {
        blockName: "email-contact",
        key: "email",
        value: "sarah.johnson@example.com",
      },
      {
        blockName: "radio-satisfaction",
        key: "satisfaction_rating",
        value: "Very Satisfied",
      },
      {
        blockName: "checkbox-improvements",
        key: "improvement_areas",
        value: ["User Experience"],
      },
      {
        blockName: "textarea-comments",
        key: "comments",
        value: "Great service! Very happy with the experience.",
      },
    ],
  },
  {
    ...
    responses: [
      ...
      },
      {
        blockName: "checkbox-improvements",
        key: "improvement_areas",
        value: ["Response Time", "Customer Support"],
      },
      {
        blockName: "textarea-comments",
        key: "comments",
        value: "Good overall, but response time could be faster.",
      },
    ],
  },
  {
    ...
    responses: [
      ...
      },
      {
        blockName: "checkbox-improvements",
        key: "improvement_areas",
        value: ["Pricing", "Product Quality"],
      },
      {
        blockName: "textarea-comments",
        key: "comments",
        value: "Average experience. Some features need improvement.",
      },
    ],
  },
  {
    ...
    responses: [
      ...
      },
      {
        blockName: "textarea-comments",
        key: "comments",
        value: "Excellent! Keep up the great work.",
      },
    ],
  },
  ...
  // ========================================
  {
    ...
    responses: [
      {
        blockName: "text-fullname",
        key: "full_name",
        value: "Alexander James Thompson",
      },
      {
        blockName: "email-personal",
        key: "personal_email",
        value: "alex.thompson@personal.com",
      },
      { blockName: "text-phone", key: "phone", value: "+1 (555) 123-4567" },
      {
        blockName: "select-department",
        key: "department",
        value: "Engineering",
      },
      ...
      {
        blockName: "checkbox-equipment",
        key: "equipment_needed",
        value: ["Laptop", "Monitor", "Keyboard", "Mouse", "Headphones"],
      },
  ...
  },
  {
    ...
    responses: [
      ...
      { blockName: "radio-tshirt", key: "tshirt_size", value: "XL" },
      {
        blockName: "checkbox-equipment",
        key: "equipment_needed",
        value: ["Laptop", "Monitor", "Mouse", "Headphones"],
      },
      { blockName: "checkbox-terms", key: "agree_policies", value: true },
    ],
  },
  ...
  // ========================================
  {
    ...
    responses: [
      ...
      {
        blockName: "select-product",
        key: "product_name",
        value: "FormKit Builder",
      },
      { blockName: "number-rating", key: "experience_rating", value: 9 },
      {
        blockName: "radio-recommend",
        key: "would_recommend",
        value: "Definitely",
      },
      {
        blockName: "textarea-feedback",
        key: "likes",
        value: "Intuitive drag-and-drop interface, great form templates!",
      },
      {
        blockName: "textarea-improvements",
        key: "improvements",
        value: "Would love to see more integrations with third-party services.",
      },
    ],
  },
  {
    ...
    responses: [
      { blockName: "text-name", key: "user_name", value: "Lisa Anderson" },
      {
        blockName: "email-contact",
        key: "user_email",
        value: "lisa.anderson@company.org",
      },
      {
        blockName: "select-product",
        key: "product_name",
        value: "FormKit Analytics",
      },
      ...
      },
      {
        blockName: "textarea-feedback",
        key: "likes",
        value: "Detailed analytics and beautiful charts",
      },
      {
        blockName: "textarea-improvements",
        key: "improvements",
        value: "Custom date ranges for reports would be helpful",
      },
    ],
  },
  {
    ...
    responses: [
      ...
      },
      {
        ...
        key: "likes",
        value:
          "Well-documented API, easy to integrate, excellent developer experience",
      },
      {
        blockName: "textarea-improvements",
        key: "improvements",
        value: "All good! Maybe add webhook support for real-time events.",
      },
    ],
  },
  ...
  // ========================================
  {
    ...
    responses: [
      {
        blockName: "text-bug-title",
        key: "bug_title",
        value: "Form preview not rendering checkbox groups correctly",
      },
      {
        blockName: "select-severity",
        key: "severity",
        value: "Medium - Feature Partially Working",
      },
      {
        blockName: "select-component",
        key: "component",
        value: "Form Preview",
      },
      {
        blockName: "textarea-steps",
        key: "steps_to_reproduce",
        value:
          "1. Create a new form\n2. Add checkbox group with 5+ options\n3. Open preview\n4. Checkboxes appear stacked instead of in grid layout",
      },
      {
        blockName: "textarea-expected",
        key: "expected_behavior",
        value: "Checkboxes should display in a responsive grid layout",
      },
      {
        blockName: "textarea-actual",
        key: "actual_behavior",
        value:
          "All checkboxes are stacked vertically regardless of screen size",
      },
      {
        blockName: "text-browser",
        key: "browser_env",
        value: "Chrome 126 on macOS Sonoma",
      },
    ],
  },
  {
    ...
    responses: [
      {
        blockName: "text-bug-title",
        key: "bug_title",
        value: "Dashboard forms not loading on Safari",
      },
      {
        blockName: "select-severity",
        key: "severity",
        value: "High - Major Feature Broken",
      },
      { blockName: "select-component", key: "component", value: "Dashboard" },
      {
        ...
        key: "steps_to_reproduce",
        value:
          "1. Open dashboard on Safari\n2. Wait for forms to load\n3. Page shows loading spinner indefinitely",
      },
      {
        blockName: "textarea-expected",
        key: "expected_behavior",
        value: "Dashboard should load and display all forms within 2-3 seconds",
      },
      {
        blockName: "textarea-actual",
        key: "actual_behavior",
        value: "Loading spinner continues indefinitely, forms never appear",
      },
      {
        blockName: "text-browser",
        key: "browser_env",
        value: "Safari 17.5 on macOS",
      },
    ],
  },
